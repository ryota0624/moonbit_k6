# k6 MoonBit Example (Moon Build)

MoonBitでk6負荷テストを記述する方法を示すサンプルです。

このディレクトリは **Moon Build** を使用した従来の方法です。Viteを使用する場合は `../example-vite/` を参照してください。

**📁 ディレクトリ**: `example/example-moonbit/`
...
Viteを使用したビルドについては、`../example-vite/` ディレクトリを参照してください。
